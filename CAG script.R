...
tableau2 <- df_t2 %>%
  tbl_summary(
    ...
    label = list(
      ...
      historique_autres_anticorps_monoclonaux_vedo_tofa_stelara_golimumab_YN ~ "Autres biothérapies (Vedolizumab, Tofa, Stelara, Golimumab)",
      historique_autres_anticorps_monoclonaux_vedo_tofa_stelara_golimumab_nombre ~ "Nombre d'autres biothérapies",
