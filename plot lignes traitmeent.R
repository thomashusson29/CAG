# --- Patch : reconstruire le tableau agrégé à partir de tes nombres -------
...
# -> Construit 'dat' avec tes colonnes attendues par la suite
dat <- prep_counts(df_agg, line_col = "Ligne", therapy_col = "Therapie", count_col = "n")

# Palette qui dépend de 'dat' (comme dans ton script)
...
# Suppose que tes colonnes s'appellent comme suit (adapte ici si besoin) :
