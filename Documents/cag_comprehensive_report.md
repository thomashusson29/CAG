...
#### Taux de CPT selon le nombre de lignes
...
#### Nouveau paradigme proposé (post-2019)
```
...
1. **Effectif limité** : 37 patients (mais signal fort et cohérent)
...
#### Tableau B3. Délais détaillés (jours)
