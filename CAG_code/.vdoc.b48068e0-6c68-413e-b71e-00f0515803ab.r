...
# 2. Créer le graphique ggplot (Camembert = Barplot + Coordonnées polaires)
...
ggsave("~/Documents/Projets/CAG/CAG_code/CAG_figures/pie_chart_operes.svg", 
        plot = pie_chart_gg, width = 6, height = 4, units = "in")
#
#
#
#
