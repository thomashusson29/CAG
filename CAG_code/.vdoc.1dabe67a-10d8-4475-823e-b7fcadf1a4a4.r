...
pct <- round(prop.table(table(df$opere)) * 100, 1)
labels <- paste(c("Non opéré", "Opéré"), "\n", pct, "%")
pie_chart_operes <- pie(table(df$opere), labels = labels, main = "Répartition des patients opérés vs non opérés", col = c("lightblue", "lightcoral"))
pie_chart_operes
#export en .svg
ggsave("~/Documents/Projets/CAG/CAG_code/CAG_figures/pie_chart_operes.svg", plot = pie_chart_operes, width = 600, height = 400, units = "dpi")
ggsave("~/Documents/Projets/CAG/CAG_code/CAG_figures/pie_chart_operes.png", plot = pie_chart_operes, width = 600, height = 400, units = "dpi")
#
#
#
#
